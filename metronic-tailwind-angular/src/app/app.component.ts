import { Component, DOCUMENT, Renderer2, inject, signal } from '@angular/core';
...
export class AppComponent {
  ...
  private demoClassMap: Record<string, string> = {
    ...
    demo2:
      '[--header-height:100px] data-[kt-sticky-header=on]:[--header-height:60px]',
    demo3:
      '[--header-height:58px] [--sidebar-width:58px] [--navbar-height:56px] lg:overflow-hidden bg-muted',
    demo4:
      '[--header-height:60px] [--sidebar-width:290px] bg-muted! lg:overflow-hidden',
    demo5: '[--header-height:54px] [--sidebar-width:200px]',
    demo6:
      '[--header-height:60px] [--sidebar-width:270px] lg:overflow-hidden bg-muted',
    demo7:
